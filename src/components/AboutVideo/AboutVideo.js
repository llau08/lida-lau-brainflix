...
export default function AboutVideo (props){
    ...
    <section className="about-video">
        ...
        <ul className="about-video__list">
            ...
            <li className="about-video__list-i--three"><img className="about-video__icon" src={views} alt="eye icon"/>{props.video.views}</li>
            <li className="about-video__list-i--two">{formatTimestamp}</li>
